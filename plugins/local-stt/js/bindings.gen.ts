...
export const commands = {
  ...
  async soniqoModelDir(model: LocalModel): Promise<Result<string, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-stt|soniqo_model_dir", {
          model,
        }),
      };
    } catch (e) {
  ...
  async cancelDownload(model: LocalModel): Promise<Result<boolean, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-stt|cancel_download", { model }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getServerForModel(
    model: LocalModel,
  ): Promise<Result<ServerInfo | null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:local-stt|get_server_for_model", {
          model,
        }),
      };
    } catch (e) {

...
- Chat controls now live inside the chat panel, and the assistant is labeled Notiz AI
- Folder controls have been removed so sessions remain the primary organization model
- App icon and installer artwork updated for the Notiz brand
- In-app web links now point to Notiz pages instead of older Char docs

...
- Chat controls now live inside the chat panel, and the assistant is labeled Skald AI
- Folder controls have been removed so sessions remain the primary organization model
- App icon and installer artwork updated for the Skald brand
- In-app web links now point to Skald pages instead of older Char docs

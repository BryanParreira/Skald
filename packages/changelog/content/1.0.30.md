...
- New stable installs now use the Skald data folder by default
- Existing Skald data folders and database paths are still preserved so current installs continue to open the same data

...
- New stable installs now use the Notiz data folder by default
- Existing Notiz data folders and database paths are still preserved so current installs continue to open the same data

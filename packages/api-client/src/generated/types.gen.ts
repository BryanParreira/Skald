...
export type BirthdayPropertyType =
  | "birthday"
  | "anniversary"
  | "self"
  | "other"
...
export type ConferenceCreateStatusCode =
  | "pending"
  | "success"
  | "failure"
  | "unknown";
...
export type TranscriptionConfigurationModel =
...
export type GoogleListCalendarsResponse2 =
  GoogleListCalendarsResponses[keyof GoogleListCalendarsResponses];
...
export type GoogleListEventsResponse2 =
  GoogleListEventsResponses[keyof GoogleListEventsResponses];
...
export type OutlookListCalendarsResponse2 =
  OutlookListCalendarsResponses[keyof OutlookListCalendarsResponses];
...
export type OutlookListEventsResponse2 =
  OutlookListEventsResponses[keyof OutlookListEventsResponses];
...
export type GoogleGetAttachmentResponse =
  GoogleGetAttachmentResponses[keyof GoogleGetAttachmentResponses];
...
export type GoogleGetMessageResponse =
  GoogleGetMessageResponses[keyof GoogleGetMessageResponses];
...
export type GoogleGetProfileResponse =
  GoogleGetProfileResponses[keyof GoogleGetProfileResponses];
...
export type GoogleGetThreadResponse =
  GoogleGetThreadResponses[keyof GoogleGetThreadResponses];
...
export type GoogleListHistoryResponse =
  GoogleListHistoryResponses[keyof GoogleListHistoryResponses];
...
export type GoogleListLabelsResponse =
  GoogleListLabelsResponses[keyof GoogleListLabelsResponses];
...
export type GoogleListMessagesResponse =
  GoogleListMessagesResponses[keyof GoogleListMessagesResponses];
...
export type GoogleListThreadsResponse =
  GoogleListThreadsResponses[keyof GoogleListThreadsResponses];
...
export type DeleteConnectionResponse2 =
...
export type NangoWebhookResponse =
...
export type SttListenBatchResponse =
  SttListenBatchResponses[keyof SttListenBatchResponses];
...
export type CanStartTrialResponse2 =
  CanStartTrialResponses[keyof CanStartTrialResponses];
...
export type StartTrialResponse2 =
  StartTrialResponses[keyof StartTrialResponses];
...
export type CreateContactResponse2 =
...
export type GithubListReposResponse =
  GithubListReposResponses[keyof GithubListReposResponses];
...
export type GithubListTicketsResponse =
  GithubListTicketsResponses[keyof GithubListTicketsResponses];
...
export type LinearListTeamsResponse =
  LinearListTeamsResponses[keyof LinearListTeamsResponses];
...
export type LinearListTicketsResponse =
  LinearListTicketsResponses[keyof LinearListTicketsResponses];

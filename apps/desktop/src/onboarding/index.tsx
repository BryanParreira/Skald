...
import { commands as sfxCommands } from "@notiz/plugin-sfx";
      ...
      <div className="scroll-fade-y relative z-10 flex-1 overflow-y-auto">
        <div className="flex flex-col gap-4 px-12 pb-16">
          <OnboardingSection
            ...
            description={
              <Trans>
                Notiz needs access to your microphone and system audio to record
          ...
          <OnboardingSection
            ...
            description={
              <Trans>
                Notiz will sync your calendar to get meeting reminders
              </Trans>
            }

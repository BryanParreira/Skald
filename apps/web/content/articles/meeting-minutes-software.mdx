...
| Skald          | Control over data and AI stack | Free. $25/month for Pro     |
...
### 1. Skald - control over your data and AI stack

![Skald](/api/assets/blog/blog/char-summary.png)

**[Skald](/)** is an open-source AI note-taker that stores your data locally and gives you complete control over the AI stack.
...
Skald captures system audio without joining meetings as a bot. During meetings, it transcribes conversations in real-time and combines any notes you've taken with transcripts to create a summary when the meeting ends.
...
- **Local-first processing** (Skald) provides maximum privacy
...
If you value both functionality and control, Skald is worth a look. You get AI-powered features without giving up ownership of your data, and you can export everything as plain markdown with zero lock-in.

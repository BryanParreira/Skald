...
| ---------------- | ----------------------------------------------------------------------- | ----------------------------------- |
| Skald            | AI note-taker with complete control over data and AI stack              | Free, Pro $25/mo                    |
...
### 1. Skald (formerly Skald): best Mac app for meeting notes

![Skald review](/api/assets/blog/articles/mac-productivity-apps/image-1.png)

Meetings suck, but they're inevitable. The next best thing is making sure you never miss a detail with a note-taker that doesn't lock your data in someone else's cloud. I built Skald for this reason.
...
- Pairs perfectly with markdown-based tools like Skald
...
If you're drowning in meetings and losing track of what was said, try Skald.

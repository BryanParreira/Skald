...
| Notiz    | Meeting notes                  | ✅              | ✅              | Free / $25/mo     |
...
- Your choice of AI stack - Use Notiz's managed cloud service, bring your own API keys (OpenAI, Anthropic, Deepgram, others), or run fully local via Ollama or LM Studio
...
- [Meeting notes](/blog/obsidian-meeting-notes/) from Notiz land directly in your vault since both use markdown
...
If you're in back-to-back meetings and losing track of what was said and decided, start with **Notiz**. Everything else on this list is for organizing knowledge you've already captured - Notiz is for capturing it in the first place.

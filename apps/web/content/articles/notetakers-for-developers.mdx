...
| ------------------------ | ------------------------------------------------------ | -------------------------------------- |
| Skald                    | AI meeting notes with local files and your own LLM     | Free (BYOK) / Pro $25/mo               |
...
- Install with brew install --cask fastrepl/fastrepl/skald. There's a CLI. The repo is public on GitHub.
...
- No mobile app. If you need to record a call from your phone, Skald can't help yet.
- No built-in CRM integrations. Meeting notes stay in Skald unless you export or sync manually.
...
If your main problem is meeting notes and you want to own the transcript, Skald captures system audio without a bot, stores everything locally, and lets you run any LLM you want. The tradeoff is macOS-only for now.
...
For meeting notes specifically, you can [download Skald](/download) and try it in your next meeting.

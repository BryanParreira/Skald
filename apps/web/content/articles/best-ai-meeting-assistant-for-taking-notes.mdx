...
| ------------ | ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| Skald        | Zero lock-in, complete control over data and AI   | Universal compatibility - works with all platforms without joining as bot, supports offline/in-person                          |
...
<Image
  src="/api/assets/blog/best-ai-meeting-assistant-for-taking-notes/skald-app-mock.jpg"
  alt="Skald app mockup"
/>

#### About Skald's AI notetaker:
...
Skald is free forever for local transcription, BYOK, and all core features. The managed cloud service is $25/month for the easiest setup. An Enterprise plan provides on-premises deployment, SSO, custom branding, and admin controls.
...
Granola captures audio directly from your device like Skald, offering a familiar notepad interface, custom templates, and intelligent note enhancement. However, it sends data to the cloud for AI processing, which can create privacy concerns for organizations with strict compliance requirements.
...
Unlike Skald and Granola's bot-free approach, Otter.ai sends an AI assistant (OtterPilot) that automatically joins your Zoom, Google Meet, and Microsoft Teams meetings to capture everything. When meetings end, Otter condenses hour-long discussions into 30-second summaries and automatically emails participants with structured notes.
...
If you want the second option, Skald is the outlier here. Your meetings become files. You choose the AI layer. You can run local, use your own keys, or use the managed cloud without rebuilding your workflow around a proprietary format.

[**Download Skald for macOS**](/download) if that is the kind of setup you want to keep long term.

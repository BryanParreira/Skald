...
This is a materially different setup from [Google Gemini's human review policy](/blog/google-gemini-data-retention-policy/#human-review-in-plain-terms), where reviewers can access conversations more broadly for quality evaluation.
...
Both Azure OpenAI and [OpenAI's direct API](/blog/chatgpt-data-retention-policy/#the-openai-api-has-meaningfully-better-data-controls) offer enterprise-grade data controls including ZDR. The practical differences come down to infrastructure and compliance coverage.
...
## Using Azure OpenAI Through Skald

[Skald](/) supports custom API endpoints, which means you can connect your Azure OpenAI deployment directly. Your meeting data goes through your Azure subscription under your enterprise data policy.

If your organization has a Modified Abuse Monitoring or ZDR agreement in place, those protections apply to requests routed through Skald as well. Your notes are stored on your device regardless of which provider processes them.

...
## How Claude.ai Compares to Using Claude Through Skald

|                              |                                    |                                     |
| ---------------------------- | ---------------------------------- | ----------------------------------- |
|                              | **Claude.ai (Consumer)**           | **Anthropic API via Skald**         |
...
And if Anthropic's policy trajectory gives you pause, you're not locked in. Skald supports OpenAI, Mistral, Google Gemini, and local models via Ollama. Your notes stay on your device regardless of which AI processes them. Switching providers doesn't mean starting over.

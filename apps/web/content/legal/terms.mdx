...
summary: "Terms and conditions for using Skald"
---

## 1. Agreement to Terms

By accessing or using Skald ("the Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Service.

## 2. Description of Service

Skald is an open-source note-taking and meeting transcription application. It helps you capture, organize, and manage your notes and meeting context.

### 2.1 Local-First Architecture

Skald is designed as a local-first application. Your notes, transcripts, and meeting data are stored locally on your device in plain markdown files. You can run Skald completely offline using a local language model (e.g., via LM Studio or Ollama). Cloud-based features — such as cloud transcription and AI summarization — are optional and require an internet connection.

### 2.2 Account and Cloud Features

You can use Skald without an account by running it in fully local mode. If you want to use cloud-powered transcription and summarization, an account is created during onboarding so you can experience the full product. If you no longer wish to maintain an account, you can request account deletion at any time (see Section 3.3).
...
You may request deletion of your account at any time by contacting us at hello@skald.so. Upon account deletion, your cloud-stored data will be removed within 30 days. Your locally stored data remains on your device and is not affected by account deletion. After deleting your account, Skald will continue to function with local-only features.
...
The Skald source code is open source and licensed under the MIT License. The Skald name, logo, and trademarks are owned by Fastrepl, Inc. The Skald cloud service and any proprietary components are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
...
Skald is free and open source. Optional cloud features may require payment. You agree to pay all fees associated with your use of paid features. All fees are non-refundable unless otherwise specified.
...
- **Marketing communications:** Newsletters, promotional content, and other updates about Skald and related offerings

You may opt out of marketing communications at any time by clicking the "unsubscribe" link in any marketing email or by contacting us at hello@skald.so. Opting out of marketing communications will not affect transactional or service-related messages.

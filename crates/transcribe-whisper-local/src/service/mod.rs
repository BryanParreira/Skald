...
pub(crate) fn build_model(
    ...
    params: &ListenParams,
) -> Result<skald_whisper_local::Whisper, crate::Error> {
...
pub(crate) fn load_model(
    model_path: &Path,
) -> Result<skald_whisper_local::LoadedWhisper, crate::Error> {
...
pub(crate) fn build_model_with_languages(
    loaded_model: &skald_whisper_local::LoadedWhisper,
    languages: Vec<skald_whisper::Language>,
) -> Result<skald_whisper_local::Whisper, crate::Error> {
...
fn build_chunk_segments(
    raw_segments: Vec<skald_whisper_local::Segment>,
    chunk_start_sec: f64,

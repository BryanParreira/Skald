...
fn transform_mentions_in_markdown(markdown: &str) -> String {
    ...
    re.replace_all(markdown, |caps: &regex::Captures| {
        ...
        format!(
            r#"<a class="mention" data-mention="true" data-id="{}" data-type="{}" data-label="{}" href="javascript:void(0)" onclick="event.preventDefault(); if (window.__NOTIZ_NAVIGATE__) window.__NOTIZ_NAVIGATE__('{}');">@{}</a>"#,
...
## Stay Connected
- Follow updates on [X](https://notiz.com/x).
- Join the community and chat on [Discord](https://notiz.com/discord). 

# Participants:

* [John Jeong](mailto:john@notiz.com)
* [Yujong Lee](mailto:yujonglee@notiz.com)
...
"#;
    ...
    fn test_md_to_md_4() {
        let input = r#"
# Notiz: Enhanced Meeting Notes

# Objective: Introduce Notiz as a smart notepad for enhanced meeting productivity.
...
# Stay Connected: Promote Notiz through X and Discord.
...
# Further Information: Follow updates on [X](https://notiz.com/x) and [Discord](https://notiz.com/discord).
        "#;

        insta::assert_snapshot!(md_to_md(input).unwrap().to_string(), @"# Further Information: Follow updates on [X](https://notiz.com/x) and [Discord](https://notiz.com/discord).");
    }
...
"#;
        ...
        <ul>
        <li>Follow updates on <a href="https://notiz.com/x">X</a>.</li>
        <li>Join the community and chat on <a href="https://notiz.com/discord">Discord</a>.</li>
        </ul>
        "#);
    }

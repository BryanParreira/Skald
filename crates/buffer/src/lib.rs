...
fn transform_mentions_in_markdown(markdown: &str) -> String {
    ...
    re.replace_all(markdown, |caps: &regex::Captures| {
        ...
        format!(
            r#"<a class="mention" data-mention="true" data-id="{}" data-type="{}" data-label="{}" href="javascript:void(0)" onclick="event.preventDefault(); if (window.__SKALD_NAVIGATE__) window.__SKALD_NAVIGATE__('{}');">@{}</a>"#,
...
## Stay Connected
- Follow updates on [X](https://skald.com/x).
- Join the community and chat on [Discord](https://skald.com/discord). 

# Participants:

* [John Jeong](mailto:john@skald.com)
* [Yujong Lee](mailto:yujonglee@skald.com)
...
"#;
    ...
    fn test_md_to_md_4() {
        let input = r#"
# Skald: Enhanced Meeting Notes

# Objective: Introduce Skald as a smart notepad for enhanced meeting productivity.
...
# Stay Connected: Promote Skald through X and Discord.
...
# Further Information: Follow updates on [X](https://skald.com/x) and [Discord](https://skald.com/discord).
        "#;

        insta::assert_snapshot!(md_to_md(input).unwrap().to_string(), @"# Further Information: Follow updates on [X](https://skald.com/x) and [Discord](https://skald.com/discord).");
    }
...
"#;
        ...
        <ul>
        <li>Follow updates on <a href="https://skald.com/x">X</a>.</li>
        <li>Join the community and chat on <a href="https://skald.com/discord">Discord</a>.</li>
        </ul>
        "#);
    }

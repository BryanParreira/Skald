...
use notiz_api_nango::{NangoConnectionState, NangoIntegrationId, Outlook};
use notiz_outlook_calendar::{ListCalendarsResponse, ListEventsResponse, OutlookCalendarClient};
...
pub async fn list_events(
    ...
    let outlook_req = notiz_outlook_calendar::ListEventsRequest {

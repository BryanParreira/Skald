...
impl RealtimeSttAdapter for NotizAdapter {
    ...
    fn is_supported_languages(
        ...
        NotizAdapter::is_supported_languages_live(languages, model)
    }
...
mod tests {
        ...
        run_url_test_cases(
            ...
            &[
                UrlTestCase {
                    ...
                    model: Some("nova-3"),
                    languages: &[ISO639::En],
                    contains: &["notiz.com", "listen", "model=nova-3", "language=en"],
                    not_contains: &[],
                },
                UrlTestCase {
                    name: "multi_language",
    ...
    fn test_url_with_keywords() {
        let adapter = NotizAdapter::default();
        ...
        assert!(url_str.contains("keyword=Notiz"));
    ...
    fn test_provider_param_preserved_in_url() {
        let adapter = NotizAdapter::default();
        let base_with_provider = "https://api.hyprnote.com/stt?provider=notiz";
        let params = owhisper_interface::ListenParams {
            model: Some("cloud".to_string()),
            languages: vec![ISO639::En.into()],
            ..Default::default()
        ...
        assert!(
            url.as_str().contains("provider=notiz"),
            "provider=notiz query param should be preserved in the final URL"
        );
    }

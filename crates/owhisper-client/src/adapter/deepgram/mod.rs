...
impl DeepgramModel {
    ...
    pub fn supports_language(&self, lang: &skald_language::Language) -> bool {
        lang.matches_any_code(self.supported_languages())
    }

    pub fn supports_multi(&self, languages: &[skald_language::Language]) -> bool {
...
impl DeepgramAdapter {
    pub fn find_model(languages: &[skald_language::Language]) -> Option<DeepgramModel> {
        if languages.len() >= 2 {
    ...
    pub fn supports_batch_language_detection(languages: &[skald_language::Language]) -> bool {
        !languages.is_empty() && languages.iter().all(language::supports_language_detection)
    }

    fn can_use_multi(languages: &[skald_language::Language]) -> bool {
    ...
    fn single_language_support(language: &skald_language::Language) -> LanguageSupport {
    ...
    pub fn recommended_model_live(languages: &[skald_language::Language]) -> Option<&'static str> {
...
mod tests {
    ...
    fn test_model_supports_language() {
        let en: skald_language::Language = ISO639::En.into();
        let zh: skald_language::Language = ISO639::Zh.into();
    ...
    fn test_en_ca_with_nova3_general_not_supported() {
        let en_ca: skald_language::Language = "en-CA".parse().unwrap();
    ...
    fn test_en_us_with_nova3_general_supported() {
        let en_us: skald_language::Language = "en-US".parse().unwrap();

...
pub async fn create_session(
    ...
    match body.mode {
        ...
        SessionMode::Reconnect => {
            ...
            let reconnect_req = notiz_nango::ReconnectSessionRequest {
                ...
                match state.nango.reconnect_session(reconnect_req).await {
                    ...
                    Err(notiz_nango::Error::Api(404, response_body)) => {
                        tracing::warn!(
                            ...
                            notiz.connection.id = %existing.connection_id,
                            notiz.connection.status = %existing.status,
    ...
    let req = notiz_nango::CreateConnectSessionRequest {
        end_user: notiz_nango::EndUser {
            id: user_id,
            display_name: None,
            email,
            tags: Some(tags),

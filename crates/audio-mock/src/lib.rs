...
pub use skald_audio::{AudioProvider, CaptureConfig, CaptureFrame, CaptureStream, Error};

const MOCK_MIC_DEVICE_NAME: &str = "mock-mic";
const MOCK_MIC_AUDIO_ENV: &str = "SKALD_MOCK_MIC_AUDIO";
const MOCK_SPK_AUDIO_ENV: &str = "SKALD_MOCK_SPK_AUDIO";
...
fn audio_paths_for_selection(selection: u32) -> AudioPaths {
    match selection {
        // MOCK_AUDIO=1
        1 => AudioPaths {
            mic: skald_data::english_10::AUDIO_MIC_MP3_PATH,
            spk: skald_data::english_10::AUDIO_SPK_MP3_PATH,
        },

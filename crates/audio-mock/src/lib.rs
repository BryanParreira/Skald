...
pub use notiz_audio::{AudioProvider, CaptureConfig, CaptureFrame, CaptureStream, Error};

const MOCK_MIC_DEVICE_NAME: &str = "mock-mic";
const MOCK_MIC_AUDIO_ENV: &str = "NOTIZ_MOCK_MIC_AUDIO";
const MOCK_SPK_AUDIO_ENV: &str = "NOTIZ_MOCK_SPK_AUDIO";
...
fn audio_paths_for_selection(selection: u32) -> AudioPaths {
    match selection {
        // MOCK_AUDIO=1
        1 => AudioPaths {
            mic: notiz_data::english_10::AUDIO_MIC_MP3_PATH,
            spk: notiz_data::english_10::AUDIO_SPK_MP3_PATH,
        },
